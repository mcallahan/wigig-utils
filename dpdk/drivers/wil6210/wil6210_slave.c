...
static netdev_tx_t wil_slave_tx_data(void *dev, u8 cid, struct rte_mbuf *skb)
{
#ifndef WIL6210_PMD
	struct wil_slave_entry *slave = dev;
	struct wil6210_priv *wil = slave->wil;
...
int wil_slave_rx_data(struct wil6210_vif *vif, u8 cid, struct rte_mbuf *skb)
{
#ifndef WIL6210_PMD
	struct wil6210_priv *wil = vif_to_wil(vif);
	struct wil_slave_entry *slave;
...
struct wil6210_priv *wil_slave_priv(void *dev_ctx)
{
	struct wil_slave_entry *slave = dev_ctx;
	return slave->wil;
}
