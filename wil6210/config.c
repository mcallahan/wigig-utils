...
static struct wil_config_entry config_table[] = {
	...
	WIL_CONFIG_INI_PARAM(WIL_CONFIG_REG_HINTS_NAME,
			     ...
			     WIL_CONFIG_BOOL_SIZE, WIL_CONFIG_BOOL_MIN,
			     WIL_CONFIG_BOOL_MAX),
	WIL_CONFIG_INI_PARAM(WIL_CONFIG_SCAN_DWELL_TIME_NAME,
			     wil_ini_param_type_unsigned, &scan_dwell_time, 0,
			     sizeof(scan_dwell_time),
			     0, WIL_CONFIG_MAX_UNLIMITED),
	WIL_CONFIG_INI_PARAM(WIL_CONFIG_SCAN_TIMEOUT_NAME,
			     wil_ini_param_type_unsigned, &scan_timeout, 0,
			     sizeof(scan_timeout), 0,
			     WIL_CONFIG_MAX_UNLIMITED),
